...
from model.generation_result import (
    GeneratedDocument,
    GenerationResult,
)
...
class TestGeneratedDocument:
    ...
    def test_basic_creation_with_tokens(self):
        ...
        doc = GeneratedDocument(
            raw_identifier="Test Document",
            normed_identifier="test_document_abc123",
            tokens=tokens,
            text=None,
            source="generated",
            is_root=True,
        ...
        assert doc.raw_identifier == "Test Document"
        assert doc.normed_identifier == "test_document_abc123"
    ...
    def test_basic_creation_with_text(self):
        ...
        doc = GeneratedDocument(
            ...
            source="corpus",
            is_root=False,
            parent_raw_identifier="Parent Document",
        )
        ...
        assert doc.parent_raw_identifier == "Parent Document"
...
class TestGenerationResult:
    ...
    def setup_method(self):
        ...
        self.root_doc = GeneratedDocument(
            raw_identifier="Root Document",
            normed_identifier="root_document_abc123",
            tokens=np.array([1, 2, 3]),
            text="Root text",
            source="generated",
            is_root=True,
        ...
        self.aux_doc1 = GeneratedDocument(
            raw_identifier="Auxiliary 1",
            normed_identifier="auxiliary_1_def456",
            tokens=np.array([4, 5, 6]),
            text="Aux 1 text",
            source="generated",
            is_root=False,
            parent_raw_identifier="Root Document",
        )

        self.aux_doc2 = GeneratedDocument(
            raw_identifier="Auxiliary 2",
            normed_identifier="auxiliary_2_ghi789",
    ...
    def test_get_document_by_identifier_raw(self):
        """Test getting document by raw identifier."""
        result = GenerationResult(
            root_document=self.root_doc,
            auxiliary_documents=[self.aux_doc1, self.aux_doc2],
            generation_config={},
        ...
        doc = result.get_document_by_identifier("Auxiliary 1")
        assert doc == self.aux_doc1

    def test_get_document_by_identifier_normed(self):
        """Test getting document by normed identifier."""
        result = GenerationResult(
            root_document=self.root_doc,
            auxiliary_documents=[self.aux_doc1, self.aux_doc2],
            generation_config={},
        ...
        doc = result.get_document_by_identifier("auxiliary_1_def456")
        assert doc == self.aux_doc1

    def test_get_document_by_identifier_not_found(self):
        ...
        doc = result.get_document_by_identifier("Nonexistent")
        assert doc is None
...
class TestIntegration:
    ...
    def test_complex_document_graph(self):
        ...
        root = GeneratedDocument(
            raw_identifier="Main Article",
            normed_identifier="main_article_aaa111",
            tokens=np.array([1, 2, 3]),
            text="Main content",
            source="generated",
            is_root=True,
        ...
        aux1 = GeneratedDocument(
            raw_identifier="Reference 1",
            normed_identifier="reference_1_bbb222",
            tokens=np.array([4, 5]),
            text="Ref 1",
            source="corpus",
            is_root=False,
            parent_raw_identifier="Main Article",
        )

        aux2 = GeneratedDocument(
            raw_identifier="Reference 2",
            normed_identifier="reference_2_ccc333",
            tokens=np.array([6, 7]),
            text="Ref 2",
            source="generated",
            is_root=False,
            parent_raw_identifier="Reference 1",
        )
        ...
        assert result.get_document_by_identifier("Main Article") == root
        assert result.get_document_by_identifier("reference_1_bbb222") == aux1
        assert result.get_document_by_identifier("Reference 2") == aux2
