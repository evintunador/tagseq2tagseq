...
# $1 = run name under $REPO/runs, OR an absolute run dir (fss-data runs live outside the repo).
RD="$1"; case "$RD" in /*) ;; *) RD="$REPO/runs/$1";; esac
MODE="${2:-cdl}"; CKPT_NAME="${3:-best_model.pt}"
